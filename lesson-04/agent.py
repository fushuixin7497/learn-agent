#!/usr/bin/env python3
"""
模块 3：Context 管理 —— 带窗口压缩的 Agent Loop
===================================================
在 lesson-03 基础上，引入 ContextManager 处理长任务导致的 context 爆掉。
...
运行方式：
    ...
    # 切换 context 管理策略（默认 truncate）
    export CONTEXT_STRATEGY=truncate      # 截断
    export CONTEXT_STRATEGY=summarize     # 摘要
    export CONTEXT_STRATEGY=memory        # 外置记忆
...
def main():
    ...
    print("=" * 60)
    print("🧠 模块 3：Context 管理 —— 长任务稳定 Agent")
    print(f"   模型: {MODEL}")
    ...
    print("=" * 60)
    print("输入 'quit' 退出")
    print("提示：试试 '生成100段超长文本，然后告诉我第10段说了什么'")
    print("-" * 60)
